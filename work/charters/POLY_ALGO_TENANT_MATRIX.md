...
| `376c594c` (swiss-gap)  | swisstony     | `position_gap`                          | p80 / $15 / `target_scale=1e-4` (bootstrap default) | `POLY_PREVIEW_TENANT_GAP_*`        | (just registered)        | 🟡 first allowed preview experiment; the A/B counterpart to trust-twin for D2 phase-2 done condition                              |
