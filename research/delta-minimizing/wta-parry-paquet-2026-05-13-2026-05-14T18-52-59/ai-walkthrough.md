...
| ---------------------------------- | --------- | --------- | ------ | ------------ | ------------ | --------- | --------- | --------- |
| Paris: Diane Parry vs Chloe Paquet | $7.70     | $11.83    | +53.8% | $5629        | $3640        | -35.3%    | -89.1%    | -$6.86    |
...
### D2 · Wrong-side allocation vs target (charter D2, score 77)

- Our wallet sank $7.70 into the side OPPOSITE swisstony's primary (100% of our cost).

### D3 · Hedge blindness (charter D3, score 21)

- 21 `target_dominant_other_side` skips; 0 on swisstony's final primary side.

### D4 · VWAP gate bouncing (charter D4, score 1)

- 1 `vwap_floor_breach` skips total; 0 were on swisstony's primary side.
