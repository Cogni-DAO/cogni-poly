...
const REQUIRED_PATHS: PathRequirement[] = [
  ...
  { anyOf: ["nodes/poly/app/src/app"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/features"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/ports"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/core"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/adapters/server"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/shared"], kind: "dir" },
  { anyOf: ["nodes/poly/app/src/bootstrap"], kind: "dir" },
  { anyOf: ["nodes/poly/app/public"], kind: "dir" },
