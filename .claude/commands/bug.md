...
**Bootstrap first**: read `AGENTS.md`, the suspect code, related tests / logs / stack traces, and `GET https://poly.cognidao.org/api/v1/work/items?types=bug&node=<node>` to check for duplicates.
