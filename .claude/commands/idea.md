...
**Bootstrap first** (every lifecycle skill assumes this): read `AGENTS.md`, scan related projects in `work/projects/`, and `GET https://poly.cognidao.org/api/v1/work/items?node=<node>` for adjacent items. Don't duplicate.
